...
isomap.fit(all_points_train.reshape(510,-1))   

clf =  EllipticEnvelope(contamination=0.02)
clf.fit(isomap.transform(all_points_train.reshape(510,-1)).reshape(510,-1))
labels_all_train_pred=clf.predict(isomap.transform(all_points_train.reshape(510,-1)).reshape(510,-1))
print(labels_all_train_pred)
labels_all_test_pred=clf.predict(isomap.transform(all_points_test.reshape(110,-1)).reshape(110,-1))
print(labels_all_train_pred)
